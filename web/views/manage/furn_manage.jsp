    ...
    <script type="text/javascript">
        $(function () {
            $("a.deleteCss").click(function(){
                var furnName = $(this).parent().parent("td:eq(1)").text();
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <div class="header-bottom-set dropdown">
                            <a href="#">Background management</a>
                        </div>


                        <div class="header-bottom-set dropdown">
                            <a href="views/manage/furn_add.jsp?pageNo=${requestScope.page.pageNo}">Add</a>
                        </div>
                    </div>
                </div>
                <!-- Header Action End -->
...
<div class="cart-main-area pt-100px pb-100px">
    <div class="container">
        <h3 class="cart-page-title">Background management</h3>
        <div class="row">
        ...
        <div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
            <ul>
                ...
                <c:if test="${requestScope.page.pageNo >1}">
                    <li><a href="manage/furnServlet?action=page&pageNo=${requestScope.page.pageNo-1}">Previous</a></li>
                </c:if>
                ...
                <li><a href="manage/furnServlet?action=page&pageNo=${requestScope.page.pageNo+1}">Next</a></li>
                </c:if>
